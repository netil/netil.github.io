...
> 운영을 통해 누적된 노하우를 지속적으로 문서화 <!-- .element: class="cyan fragment" -->

----------

## Pain points

어떤 소식을 큐레이션 할지가 제일 중요 → <span class="yellow">퀄리티</span><br>
...
- 운좋게 '네이버'라는 브랜드로 인해 다양한 시도를 할수 있었다고 생각
...
## 작게라도 시작해 볼 것! <!-- .element: style="margin-top:35px;color:#ecb45a;font-family:ELAND_Nice" -->
